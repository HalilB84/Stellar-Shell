...
ShaderEffect {
    ...
    property real beatMultiplier: 10.0 
    ...
    property vector3d color1: Qt.vector3d(0.03, 0.0, 0.0)
    property vector3d color2: Qt.vector3d(0.02, 0.01, 0.0)
    ...
    Timer {
        ...
        onTriggered: {
            ...
            let jump = Math.max(1.0, intensity * 6.0) 
            let frametime = 0.016 
